      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
        {topTen.map((coin) => (
          <Link
            to={`/coin/${coin.id}`}
            key={coin.id}
            className="bg-gradient-to-br from-blue-100 to-blue-200 p-5 rounded-2xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300"
          >
